...
4. **Symlink plugin to extensions**:
   ```bash
   sudo -u openclaw ln -s /home/erebus/agent/coding-tool /var/lib/openclaw/.openclaw/extensions/coding-tool
   ```
5. **Set directory permissions** (openclaw needs to traverse the symlink):
   ```bash
   chmod o+x /home/erebus /home/erebus/agent
   ```
